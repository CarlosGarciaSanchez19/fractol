...
- While viewing the Julia fractal, press and hold the left mouse button to dynamically adjust the Julia parameter to the cursor's position. Release the button to lock the parameter. You can also do this in the Mandelbrot set and then change to Julia to see the relation between Mandelbrot points and Julia fractals.
